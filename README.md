...
A Simple Eclipse RCP Demo application. A ready to use playground for Java OOA/D and to practices programming coding skills.
...
The demo version is provided with no encryption and is intended for eduction purpose only.
